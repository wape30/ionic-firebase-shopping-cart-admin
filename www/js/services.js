...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://mojitos-shop.firebaseio.com/"),
    refCart = new Firebase("https://mojitos-shop.firebaseio.com/cart"),
    refUser = new Firebase("https://mojitos-shop.firebaseio.com/users"),
    refCategory = new Firebase("https://mojitos-shop.firebaseio.com/category"),
    refOrder = new Firebase("https://mojitos-shop.firebaseio.com/orders"),
    refFeatured = new Firebase("https://mojitos-shop.firebaseio.com/featured"),
		refNumeroPedidos = new Firebase("https://mojitos-shop.firebaseio.com/numeroPedidos"),
    refMenu = new Firebase("https://mojitos-shop.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
    refCart: function() {
      return refCart;
		...
		refNumeroPedidos: function() {
			return refNumeroPedidos;
		},
    refUser: function() {
      return refUser;
    },
